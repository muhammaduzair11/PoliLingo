            ...
            return (
              <li key={s.id} className="review-card review-suggestion">
                <div className="review-suggestion-head">
                  ...
                  <StatusBadge
                    status={badgeFor({ review_status: s.review_status })}
                  />
                </div>
                ...
                {s.stale && (
                  <Notice tone="warning" title="The phrase changed since">
                    Someone edited this phrase after the suggestion was made, so
                    it can&apos;t be applied as it is. Decline it, and the
                    reviewer can suggest a fresh fix.
                  </Notice>
                )}
                {!s.can_resolve && (
                  <Notice tone="info">
                ...
                {s.can_resolve && (
                  <SuggestionActions
                    ...
                    canAccept={!s.stale && changes.length > 0}
