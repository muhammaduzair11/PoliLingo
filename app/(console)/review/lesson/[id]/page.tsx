...
export default async function ReviewLessonPage({
  ...
  return (
    <div className="review-page">
      ...
      <StanceNotice stance={stance} what="lesson" varietyName={variety.name} />

      {!submitted && !lesson.is_demo && (
        <Notice tone="info" title="Not submitted yet">
          The editor is still working on this lesson. You can review its phrases
          now; the lesson itself is ready for review once they submit it.
        </Notice>
      )}
